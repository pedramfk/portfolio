...
public final class RuntimeConfiguration {
    ...
    private final SparkConf createSparkConf() throws ClassNotFoundException {
        ...
        return new SparkConf().setAll(sparkConf.getSettingsAsScalaIterable());//.registerKryoClasses(sparkConf.getKryoClassesAsClassArray());
    ...
    public final SparkConfiguration getSparkConfiguration() { return sparkConf; }
    public final DataConfiguration getDataConfiguration() { return dataConf; }
    public final BaseLayerConf getBaseLayerConfiguration() { return dataConf.getBaseLayerConf(); }
    public final EvolvedLayerConf getEvolvedLayerConfiguration() { return dataConf.getEvolvedLayerConf();}
    public final SparkSession getSparkSession() { return spark; }
    public final void closeSparkSession() { spark.close(); }
