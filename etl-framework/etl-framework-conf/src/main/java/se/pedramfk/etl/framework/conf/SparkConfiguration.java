...
public final class SparkConfiguration {
    ...
    public static final SparkConfiguration create(InputStream conf) { return new Yaml().loadAs(conf, SparkConfiguration.class); }
    public static final SparkConfiguration create() { return new Yaml().loadAs(DEFAULT_CONF_FILE, SparkConfiguration.class); }

    public final scala.collection.Iterable<Tuple2<String, String>> getSettingsAsScalaIterable() { return getKeyValueSettingStreamAsScalaIterable(settings); }
    public final Class<?>[] getKryoClassesAsClassArray() throws ClassNotFoundException { return getClassNamesAsClassArray(kryoClasses); }
